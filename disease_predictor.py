...
w2 = Label(root, justify=CENTER, text="", fg="white", bg="blue")
...
destreeLb = Label(root, text="GCN", fg="white", bg="red")
...
rnf = Button(root, text="GCN", command=randomforest,bg="green",fg="yellow")
